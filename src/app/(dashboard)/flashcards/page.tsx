            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
              {processedSets.map((set) => (
                <FlashcardListItem
                  ...
                  onToggleVisibility={() => togglePublicMutation.mutate({ setId: set.id, isPublic: !set.is_public })}
...
function FlashcardListItem({
  set, onClick, onReforge, onDelete, onShare, onToggleVisibility, shareLinkCopied,
}: {
  set: FlashcardSet; onClick: () => void; onReforge: () => void; onDelete: () => void; onShare: (e: React.MouseEvent) => void; onToggleVisibility: () => void; shareLinkCopied: boolean;
}) {
