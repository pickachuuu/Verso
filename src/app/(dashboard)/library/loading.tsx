    ...
    <div className="space-y-6">
      ...
      <ClayCard variant="elevated" padding="lg" className="rounded-3xl animate-pulse">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="h-11 w-40 bg-surface rounded-2xl" />
        </div>
      </ClayCard>
                  ...
                  <div className="flex items-center gap-4 p-3 pr-5 flex-1">
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      ...
                      <div className="flex items-center gap-2 pt-1">
                        ...
                        <div className="hidden sm:block h-2.5 w-10 bg-surface/70 rounded" />
                      </div>
                    </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {Array.from({ length: 6 }).map((_, i) => (
                  <div key={i} className="w-7 h-7 bg-surface rounded-md" />
                ))}
              </div>
